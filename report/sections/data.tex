...
\item \textbf{נרמול (\textenglish{Normalization}):} תמונות הקלט
  ...
  הפיקסלים מחולקים ב־255 כדי להעביר אותם לטווח \([0,1]\). נרמול הקלט
  לטווח אחיד משפר את יציבות האימון, מקל על האופטימייזר לבצע עדכונים
  עקביים יותר, ותורם ללמידה מהירה ויציבה יותר.
...
\item \textbf{פיצול הנתונים:} הנתונים פוצלו למערכי אימון, ולידציה
  ...
  בהתאמה (פיצול זה נעשה לפני שלב האוגמנטציה שהגדיל את מערך האימון).
\end{itemize}
