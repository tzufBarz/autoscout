...
על הנתונים יש \textenglish{Augmentation} שמכפיל את מספר תמונות האימון
...
ב\href{https://app.roboflow.com/new-workspace-pyain/nums-llmwb/13}{מערך
  נתונים} עם כ-500 תמונות של רובוטים שתייגתי בעזרת
...
ידי מודל זיהוי הרובוטים מסרטונים רשמיים.
...
\begin{itemize}
  ...
  \item \textbf{Shear:} \qty{+-10}{\degree} Horizontal, \qty{+-5}{\degree} Vertical
